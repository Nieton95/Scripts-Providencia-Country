...
#---------------------------------------------------------------------------------
# 7) VALIDACIÓN CRUZADA (LEAVE-ONE-OUT)
cv_Vs <- krige.cv(
  Prof_rock ~ 1,
  VsRock_utm_sp,
  model = modelo_Vs,
...
#Se sugiere reevaluar la zonificación del polígono e incorporar información geológica auxiliar (estructural o litológica) mediante Cokriging para 
#mejorar la estimación de esta interfaz irregular.