"Interpolación Espacial de Información Geotécnico-Geológica del Subsuelo Polígono Providencia–Country, Guadalajara, Jalisco"
...
-Mapas de profundidad del nivel de agua subterránea.

-Mapas de variación de Vs30 y detección de estrato de suelo denso (N>50) y del basamento rocoso.

-Mapas de resistencia UCS de la roca.

-Mapas de integridad RQD de la roca.
